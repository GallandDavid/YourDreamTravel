...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if(!resultat.equals("")){
                switch (resultat.charAt(0)){
                    case 'r': // Reservation
                        Reservation reservation = new Reservation();
                        boolean running = true; // false if something goes wrong


                        while(running) {
                            // 1 - Choose the departure
                            ...
                            // 3 - Select a date
                            FlightDate fd = ui.chooseAFlightDate(new InMemoryFlyDateRepository().load(flight));
                            ...
                            // 4 - Get the ticket (with reduction)
                            ui.displayNbTicket();
    ...
    private static List<FlightDate> getFlightsDate() {
